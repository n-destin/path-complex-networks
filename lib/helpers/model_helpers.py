...
from models.graph_models.graphNN import GraphNN
...
def get_graph_model(args, num_features, num_classes, device):
    ...
    if args.model == 'gin':
    ...
    elif args.model in ["graphsage", 'gat', 'gcn', 'graphTransformer']:
        model = GraphNN(num_features, 
                        args.num_layers, 
                        args.emb_dim, 
                        num_classes, 
        ...
        raise ValueError("Invalid type {}.".format(args.model))
