...
def get_parser():
    ...
    parser.add_argument('--constraint_alphas', type=float, nargs="+", default=[10**-5,10**-4,10**-3,10**-2,10**-1,1], help="no alpha values")
    
    parser.add_argument("--task", type=str, default="pair", help="the task")
    return parser
